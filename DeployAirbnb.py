...
st.markdown("""### Estimativa de Preços de Diárias no Rio de Janeiro
...
categoricas = {'property_type' : ['Apartment', 'Bed and breakfast', 'Condominium', 'Guest suite', 'Guesthouse', 'Hostel', 'House', 'Loft', 'Others', 'Serviced apartment'],'room_type' : ['Entire home/apt', 'Hotel room', 'Private room', 'Shared room'],'bed_type' : ['Others', 'Real Bed'],'cancellation' : ['policy_Strict','policy_flexible', 'policy_moderate','policy_strict_14_with_grace_period']
}
...
if botao:
    ...
    modelo = joblib.load('modelo_et_90.pkl')
